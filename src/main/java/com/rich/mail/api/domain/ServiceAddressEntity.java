...
@Entity
@Table(name = "service_address", schema = "champion", catalog = "")
public class ServiceAddressEntity {
    ...
    @Basic
    @Column(name = "service_address", nullable = true, length = 255)
    ...
    public boolean equals(Object o) {
        ...
        ServiceAddressEntity that = (ServiceAddressEntity) o;
